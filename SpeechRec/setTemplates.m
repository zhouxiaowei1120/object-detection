...
NumofReg = 2;
fMatrix1 = cell(1,NumofReg);
fMatrix2 = cell(1,NumofReg);
fMatrix3 = cell(1,NumofReg);
fMatrix4 = cell(1,NumofReg);
fMatrix5 = cell(1,NumofReg);

for j = 1:NumofReg
    q = ['E:\program\HUAWEICup\语音识别\SpeechRec\SpeechData\Tope\5_' num2str(j) '.wav'];
...
for k = 1:NumofReg
    q = ['E:\program\HUAWEICup\语音识别\SpeechRec\SpeechData\Ayo\5_' num2str(k) '.wav'];
...
for l = 1:NumofReg
    q = ['E:\program\HUAWEICup\语音识别\SpeechRec\SpeechData\Sameh\5_' num2str(l) '.wav'];
...
for m = 1:NumofReg
    q = ['E:\program\HUAWEICup\语音识别\SpeechRec\SpeechData\Jim\5_' num2str(m) '.wav'];
...
for n = 1:NumofReg
    q = ['E:\program\HUAWEICup\语音识别\SpeechRec\SpeechData\Amir\5_' num2str(n) '.wav'];
